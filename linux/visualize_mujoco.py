#!/usr/bin/env python3
"""
Script para visualizar trayectorias del modelo en MuJoCo (Linux)
Ejecutar desde la raíz del repositorio: python linux/visualize_mujoco.py
"""
...
def main():
    ...
    if not os.path.exists(config_path):
        ...
        print("  python linux/visualize_mujoco.py")
        sys.exit(1)
    
    print("\n--- Visualizador de Trayectorias MuJoCo (Linux) ---")
